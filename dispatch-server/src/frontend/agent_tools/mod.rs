use crate::frontend::agent_tools::form::*;
pub(crate) mod form;
use crate::frontend::codex::service::codex_service;
...
fn agent_tools_crudkit_config(
    ...
    let check = Action::new(
        move |and_then: &Callback<Result<CrudActionAftermath, CrudActionAftermath>>| {
