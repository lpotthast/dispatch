...
use crate::{
    frontend::{
        ...
        pages::infer_dispatch_run_id,
        work_item_creation::{CreateItemOpenRequest, state_identifier_from_lane_filter},
    },
    shared::{
...
fn ItemCard(
    ...
    let href = format!("/projects/{}/items/{item_id}", encode_path(&project));
    view! {
