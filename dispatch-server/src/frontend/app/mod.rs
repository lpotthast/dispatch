...
mod tests;
use crate::frontend::{
    app::{context::provide_frontend_services, navigation::TopBar, status::SharedStatusProvider},
    items::components::provide_elapsed_time_context,
    live_events::LiveEventsProvider,
    projects::workspace::{WorkspaceBar, provide_workspace_dock_size, workspace_dock_height},
    routes::routes,
};
...
pub fn MainLayout() -> impl IntoView {
    ...
    crate::frontend::app::context::provide_frontend_stores();
