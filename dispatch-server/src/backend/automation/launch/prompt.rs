...
use crate::{
    backend::execution::prompt_text::rich_text_to_prompt_markdown,
    shared::view_models::{
...
const DISPATCH_AGENT_INSTRUCTIONS: &str = include_str!(concat!(
...
pub(crate) fn effective_input_sha256(prompt: &AutomationPrompt) -> String {
