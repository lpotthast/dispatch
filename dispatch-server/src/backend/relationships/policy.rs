...
use crate::shared::view_models::{
    WorkItemEventType, WorkItemRelationshipDirection, WorkItemRelationshipView,
};
...
impl RelationshipEndpoints {
    ...
    pub(crate) fn from_relationship(relationship: &WorkItemRelationshipView) -> Result<Self> {
        Self::new(
...
mod tests {
    ...
    fn summary(id: i64) -> crate::shared::view_models::WorkItemRelationshipItemSummary {
        crate::shared::view_models::WorkItemRelationshipItemSummary {
            id,
            title: "Item".into(),
            state: None,
            version: 1,
