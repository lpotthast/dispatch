...
pub(crate) async fn insert_contract_in_tx<C: ConnectionTrait>(
    ...
    if purpose != AgentRunPurposeV1::Ordinary || capabilities != &AgentCapabilitySetV1::ordinary() {
        bail!("only ordinary automation launches are supported by this entry point");
    }
