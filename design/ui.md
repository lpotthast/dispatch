...
The Board starts with a compact workspace bar immediately above the swim-lanes. It does not repeat the selected project as a page heading, show a general new-item action, or expose runtime paths. Useful project-path, Git-status, copy, folder, and available editor actions remain in the compact workspace bar.
